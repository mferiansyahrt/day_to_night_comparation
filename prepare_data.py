...
def synth_night_imgs(in_img_or_path, in_day_meta_data, gt_illum_mean, gt_illum_cov, dim=True, relight=True, iso=50,discard_black_level=False, _clip=True, relight_local=True, min_num_lights=5, max_num_lights=5, min_light_size = 0.5, max_light_size = 1.0, num_sat_lights=5):
